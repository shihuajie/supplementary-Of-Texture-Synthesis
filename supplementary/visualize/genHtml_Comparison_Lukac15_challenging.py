...
fnHtml = dirOut + 'Comparison_Lukac15_challenging.html'
f = open(fnHtml, 'w')
f.write('<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">\n')
f.write('<html><head></head>\n')
f.write('<link rel="stylesheet" type="text/css" href="../style.css" />\n')
f.write('<body><title>Comparison_Lukac15_challenging</title>\n')
...
for i in fileIdRange:
  ...
  for j in range(1, len(imgDirList)):
      ...
      f.write('<td style="width:256px; height:256px"><a href="%s"><img style="border: 0px; width: 256px; height: 256px;" alt="%d" src="%s"/></a></td>\n' % (fnImg, i, fnImg))
  f.write('</tr>\n') 
